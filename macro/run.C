...
class Run
{
   ...
   private:
      ...
      void read(char* txt)
      {
         t = new TTree("t","t");
         t->SetMarkerStyle(20);
         t->ReadFile(txt,"iev/I:maxLayer:x01/D:y01:R1:x02/D:y02:R2:nsig_odd/I:nsigin_odd:nsigout_odd:nin_odd:ninsig_odd:ninnoise_odd:nsig_even/I:nsigin_even:nsigout_even:nin_even:nin_even:ninnoise_even:dr/D:z1mc:ptmc:pzmc:imin/I:nhits:x0ini/D:y0ini:Rini:rad0iniodd:Liniodd:rad0inieven:Linieven:chi2odd:x0odd:y0dd:Rodd:rad0odd:Lodd:z1odd:ptodd:pzodd:chi2even:x0even:y0even:Reven:rad0even:Leven:z1even:pteven:pzeven");
      };
